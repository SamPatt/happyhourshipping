...
(function () {
  ...
  const SQUARE_TIERS = [
    [0.0000, 0.4999, 8.49,  "0 to 0.4999 lb"],
    [0.5000, 1.0000, 10.99, "0.5 to 1.0 lb"],
    [1.0001, 2.0000, 14.49, "1.0001 to 2.0 lb"],
    [2.0001, 3.0000, 15.99, "2.0001 to 3.0 lb"],
    [3.0001, 4.0000, 17.49, "3.0001 to 4.0 lb"],
    [4.0001, 5.0000, 18.99, "4.0001 to 5.0 lb"],
    [5.0001, 6.0000, 19.99, "5.0001 to 6.0 lb"],
    [6.0001, 7.0000, 21.49, "6.0001 to 7.0 lb"],
    [7.0001, 8.0000, 22.99, "7.0001 to 8.0 lb"],
    [8.0001, 9.0000, 24.49, "8.0001 to 9.0 lb"],
    [9.0001, Infinity, 25.99, "9.0001 lb and up"],
  ];
